        ...
        <div class="row">
            ...
            <div class="searchForm text-right">
                <form method="get" action="<%=RequestHelper.getCurrentRequest().getRequestURI()%>">
                    ...
                    <input type="search" class="input-sm" placeholder="검색어를 넣어주세요" aria-controls="datatable" id="schText" name="schText" value="${pagingHelper.pageInfo.schText}"><button type="submit" class="btn btn-default">검색</button>
